...
@Component({
  selector: 'app-gestionar-lita-alumno-profesor',
  templateUrl: './gestionar-lita-alumno-profesor.component.html',
  styleUrls: ['./gestionar-lita-alumno-profesor.component.css']
})
export class GestionarLitaAlumnoProfesorComponent implements OnInit {
  usuarios: User[]=[];
  cols: any[] = [];
  items: MenuItem[] =[];
  ...
  ngOnInit(): void {
    ...
    this.usuarioService.getUserByProfesor(this.findIdUser()).subscribe({
